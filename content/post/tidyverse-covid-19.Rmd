...
### Tidy Principles
The [tidyverse](https://www.tidyverse.org/packages/) is a set of R packages specifically developed to improve the typical data analysis workflow. Most of it has been designed by [Hadley Wickham](http://hadley.nz/), who's been chief scientist at R Studio since 2013 and a philosopher of data for a lot longer than that. In 2007 he published `ggplot2`, an open source implementation of [The Grammar of Graphics](https://towardsdatascience.com/a-comprehensive-guide-to-the-grammar-of-graphics-for-effective-visualization-of-multi-dimensional-1f92b4ed4149), a statistical textbook from the 1980s that explained how to construct any data visualization in a consistent, structured manner. 

The tidyverse is the result of 

![cite](../data/covid-tidyverse/pkgs.png)

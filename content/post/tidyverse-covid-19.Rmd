...
Then we'll use the lubridate package within the tidyverse to quickly split the date into month # and day # components so we can look at data from the 9th of March onward. 
